...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if(mouseColor==-5317) {
		...
		JOptionPane.showMessageDialog(null, "Congratulations, you made it through the maze!"); }
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("toni-pitchedscream.wav"));
